...
import com.mmtap.boot.common.exception.MmtapBootException;
import com.mmtap.boot.common.utils.CommonUtil;
import com.mmtap.boot.common.utils.HibernateProxyTypeAdapter;
import com.mmtap.boot.common.utils.ResultUtil;
import com.mmtap.boot.common.utils.SecurityUtil;
import com.mmtap.boot.common.vo.Result;
import com.mmtap.boot.modules.base.entity.Department;
import com.mmtap.boot.modules.base.entity.DepartmentHeader;
import com.mmtap.boot.modules.base.entity.User;
import com.mmtap.boot.modules.base.service.DepartmentHeaderService;
import com.mmtap.boot.modules.base.service.DepartmentService;
import com.mmtap.boot.modules.base.service.RoleDepartmentService;
import com.mmtap.boot.modules.base.service.UserService;
...
public class DepartmentController {
    ...
    public void deleteRecursion(String id, String[] ids){
        ...
        if(list!=null&&list.size()>0){
            throw new MmtapBootException("删除失败，包含正被用户使用关联的部门");
        }
        // 获得其父节点
