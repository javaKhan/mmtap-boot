...
public class BootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "VideoType";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "视频体系";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "Mmtap";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.mmtap.boot.modules.video.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.mmtap.boot.modules.video.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.mmtap.boot.modules.video.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.mmtap.boot.modules.video.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.mmtap.boot.modules.video.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/mmtap/boot/generator/template";
