...
//     * 建议仅需修改
//     */
//    private static final String className = "playLog";
//
//    /**
//     * 类说明描述
//     * 建议仅需修改
//     */
//    private static final String description = "播放日志";
//
//    /**
//     * 作者名
//     * 建议仅需修改
...
//     * (文件自动生成至该包下)
//     */
//    private static final String entityPackage = "com.mmtap.boot.modules.log.entity";
//
//    /**
//     * dao对应包
//     * (文件自动生成至该包下)
//     */
//    private static final String daoPackage = "com.mmtap.boot.modules.log.dao";
//
//    /**
//     * service对应包
//     * (文件自动生成至该包下)
//     */
//    private static final String servicePackage = "com.mmtap.boot.modules.log.service";
//
//    /**
//     * serviceImpl对应包
//     * (文件自动生成至该包下)
//     */
//    private static final String serviceImplPackage = "com.mmtap.boot.modules.log.serviceimpl";
//
//    /**
//     * controller对应包
//     * (文件自动生成至该包下)
//     */
//    private static final String controllerPackage = "com.mmtap.boot.modules.log.controller";
//
//    /**
//     * 运行该主函数即可生成代码
//     * @param args
