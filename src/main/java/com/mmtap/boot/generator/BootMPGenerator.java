//package com.mmtap.boot.generator;
//
//import com.mmtap.boot.generator.bean.Entity;
...
//        entity.setTableName(tablePre+ BootGenerator.camel2Underline(className));
//        entity.setClassNameLowerCase(BootGenerator.first2LowerCase(className));
...
//        //创建文件
//        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ BootGenerator.dotToLine(entityPackage) + "/" + className + ".java";
...
//        log.info(daoResult);
//        //创建文件
//        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ BootGenerator.dotToLine(daoPackage) + "/" +className + "Mapper.java";
...
//        //创建文件
//        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ BootGenerator.dotToLine(servicePackage) + "/I" + className + "Service.java";
...
//        //创建文件
//        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ BootGenerator.dotToLine(serviceImplPackage) + "/I" + className + "ServiceImpl.java";
...
//        //创建文件
//        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ BootGenerator.dotToLine(controllerPackage) + "/" + className + "Controller.java";
